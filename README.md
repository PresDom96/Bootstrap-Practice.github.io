    ...
    <body>
            ...
            <div class="container">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="lead my-5">
                            We focus on teaching our students the fundamentals of the latest and greatest technologies to prepare them for thier first dev role.
                        </p>
                        <button class="btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#enroll">Start The Enrollment</button>
                    </div>
                    <img class="img-fluid w-50 d-none d-sm-block"  src="images/web developer.svg" alt="web developer">
                </div>
            </div>
        </section>
        <!--NewsLetter-->
                ...
                <div class="row text-center g-4">
                    <div class="col-md">
                        <div class="card bg-dark text-light">
                         ...
                         <h3 class="card-title mb-3">Virtual

                         </h3>
                         <p class="card-text">
                             Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum explicabo tempora ullam debitis. Dolor, asperiores?
                         </p>
                    ...
                    <div class="col-md">    <div class="card bg-secondary text-light">
                       ...
                       <h3 class="card-title mb-3">Hybrid
                    ...
                    <div class="col-md">    <div class="card bg-dark text-light">
                       ...
                       <h3 class="card-title mb-3">In Person
        ...
        <section id="learn" class="p-5">
            <div class="container">
               <div class="row align-center justify-content-between">
                    <div class="col-md">
                        <img src="images/JS.svg" class="img-fluid" alt="Icons">
                    </div>
                    <div class="col-md p-5">
                        <h2>Learn The Fundamentals</h2>
                        <p class="lead">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate explicabo alias iure, harum consequatur consequuntur?
                        </p>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum accusamus ullam, illo vero praesentium officiis fugit incidunt commodi quae dolorum unde dicta, fuga facilis nulla placeat atque possimus iure libero.</p>
        ...
        <section id="learn" class="p-5 bg-dark text-light">
            <div class="container">
               <div class="row align-center justify-content-between">
                    ...
                    <div class="col-md">
                        <img src="images/react.svg" class="img-fluid" alt="Icons">
                    </div>
            </div>
        </section>
        <!--Question Accordian-->
       ...
       <section id="instructors" class="p-5 bg-primary">
           <div class="container">
               ...
               <p class="lead text-center text-white mb-5">Our Instructors have 5+ years working as a web developer in the industry</p>
               <div class="row g-4">
                   <div class="col-md-6 col-lg-3">
                       <div class="card bg-light">
                           <div class="card-body text-center">
                               <img src="https://randomuser.me/api/portraits/men/31.jpg" class="rounded-circle mb-3" alt="random user">
                               <h3 class="card-title mb-3">Carl Wheezer</h3>
                               <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat sit omnis eum, laborum assumenda ad?</p>
                               <a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                               <a 
                               href="#"><i class="bi bi-facebook text-dark mx-1"></i></a><a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                   ...
                   <div class="col-md-6 col-lg-3">
                    <div class="card bg-light">
                        <div class="card-body text-center">
                            <img src="https://randomuser.me/api/portraits/men/12.jpg" class="rounded-circle mb-3" alt="random user">
                            <h3 class="card-title mb-3">Tony Gunk</h3>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat sit omnis eum, laborum assumenda ad?</p>
                            <a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                            <a 
                            href="#"><i class="bi bi-facebook text-dark mx-1"></i></a><a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card bg-light">
                        <div class="card-body text-center">
                            <img src="https://randomuser.me/api/portraits/men/18.jpg" class="rounded-circle mb-3" alt="random user">
                            <h3 class="card-title mb-3">Dandy Chiggins</h3>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat sit omnis eum, laborum assumenda ad?</p>
                            <a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                            <a 
                            href="#"><i class="bi bi-facebook text-dark mx-1"></i></a><a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card bg-light">
                        <div class="card-body text-center">
                            <img src="https://randomuser.me/api/portraits/men/5.jpg" class="rounded-circle mb-3" alt="random user">
                            <h3 class="card-title mb-3">Rick</h3>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat sit omnis eum, laborum assumenda ad?</p>
                            <a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
                            <a 
                            href="#"><i class="bi bi-facebook text-dark mx-1"></i></a><a href="#"><i class="bi bi-twitter text-dark mx-1"></i></a>
               ...
               <div class="row g-4">
                   <div class="col-md">
                       ...
                       <ul class="list-group list-group-flush lead">
                        ...
                        <li class="list-group-item">
                            <span class="fw-bold">Enroll Email:</span> enroll@frontend.com
                        </li>
                        <li class="list-group-item">
                            <span class="fw-bold">Student Email:</span> student@frontend.com
                        </li>
                       </ul>
                   </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="enroll">Enter Email Here</h5>
